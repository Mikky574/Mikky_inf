...
# sam base model
sam_pretrain_name = r"C:\Users\Mikky\Desktop\树冠数据集\USIS10K\pretrain\sam-vit-huge"
# r"C:\Users\Mikky\Desktop\树冠数据集\USIS10K\pretrain\sam-vit-huge"

sam_pretrain_ckpt_path = r"C:\Users\Mikky\Desktop\树冠数据集\USIS10K\pretrain\sam-vit-base\pytorch_model.bin"
# r"C:\Users\Mikky\Desktop\树冠数据集\USIS10K\pretrain\sam-vit-huge\pytorch_model.bin"
...
model = dict(
    ...
    # ),
    adapter=dict(
        type='UAViTAdapters', adapter_layer=range(1, 33, 2), embed_dim=1280
    ),
    # adapter=dict(
