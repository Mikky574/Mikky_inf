_base_ = ['anchor_net_base.py']

work_dir = './work_dirs/USIS10KDataset/base'
...
data_root = r'C:\Users\Mikky\Desktop\树冠数据集\USIS10K\data\第二次3~5' # 'data/1'
...
max_epochs = 30 # 24
base_lr = 1e-5 # 0.0001 # 1e-5 # 0.0001
